...
masterNext.addEventListener('click', () => mastersBox.scrollBy(Number(mastersBox.clientWidth + 5), 0))
masterPrev.addEventListener('click', () => mastersBox.scrollBy(Number(-(mastersBox.clientWidth + 5)), 0))
...
// masterNext.addEventListener('click', () => {
//   setTimeout(() => {
//     mastersBox.scrollBy(Number((mastersBox.clientWidth + 5) * numOfClick), 0);
//     console.log(Number((mastersBox.clientWidth + 5) * numOfClick));
//     numOfClick = 0;
//     console.log(`сброс до: ${numOfClick}`);
//   }, 1500);
// });
